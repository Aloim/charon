...
- Phanes cooperation: Manifest filed into the documentation tree, session-summary TODOs, and registry annotation proposals for the architect, with single-writer discipline respected.
